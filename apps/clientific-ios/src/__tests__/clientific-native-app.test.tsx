...
jest.mock('@/lib/clientific-api', () => {
  ...
  return {
    ...
    createMobileDeal: mockClientificApi.createMobileDeal,
    ...
    deleteMobileDeal: mockClientificApi.deleteMobileDeal,
    ...
    updateMobileDeal: mockClientificApi.updateMobileDeal,
