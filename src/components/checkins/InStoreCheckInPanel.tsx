...
export default function InStoreCheckInPanel({
  ...
  if (isEmbedded) {
    return (
      <div
        data-testid="in-store-checkin-panel"
        className="grid gap-3 xl:grid-cols-[minmax(0,1fr),240px]"
      >
        <div className="rounded-[26px] border border-gray-200/80 bg-white/72 p-4 shadow-[0_20px_45px_-35px_rgba(16,72,56,0.32)] dark:border-white/10 dark:bg-white/[0.04]">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-600 dark:text-gray-300">
                  Open on the front desk, kiosk, or tablet.
                </p>
              </div>
            </div>
          ...
          <div className="mt-4 flex flex-col gap-2 sm:flex-row">
            <input
              readOnly
              value={checkInUrl}
              aria-label="Check-in kiosk link"
        ...
        <div className="rounded-[26px] border border-gray-200/80 bg-white/72 p-4 text-center shadow-[0_20px_45px_-35px_rgba(16,72,56,0.32)] dark:border-white/10 dark:bg-white/[0.04]">
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-gray-500 dark:text-gray-400">
            QR code
          </p>
          {checkInUrl ? (
            <>
              <div
                ref={qrRef}
                className="mx-auto mt-4 inline-flex rounded-[28px] border border-gray-200 bg-white p-3 shadow-sm dark:border-gray-700"
              >
            ...
            <div className="mt-4 rounded-[24px] border border-dashed border-gray-300 px-4 py-10 text-sm text-gray-500 dark:border-gray-700 dark:text-gray-400">
  ...
  return (
    <section
      data-testid="in-store-checkin-panel"
      className="card relative overflow-hidden rounded-[30px] p-5 sm:p-6"
    >
