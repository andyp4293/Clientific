...
export function SubscriptionBanner() {
  ...
  return (
    <div className={`${isUrgent ? 'bg-orange-50 border-orange-200' : 'bg-blue-50 border-blue-200'} border-b px-4 py-3`}>
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center">
          <svg 
            className={`w-5 h-5 ${isUrgent ? 'text-orange-600' : 'text-blue-600'} mr-2`} 
            fill="none" 
            viewBox="0 0 24 24" 
            stroke="currentColor"
          >
        ...
        <button
          ...
          className={`${isUrgent ? 'text-orange-600 hover:text-orange-800' : 'text-blue-600 hover:text-blue-800'}`}
        >
