...
describe("staff schedule helpers", () => {
  ...
  it("formats schedule times in 12-hour labels for UI display", () => {
    expect(formatScheduleTimeLabel("00:00")).toBe("12:00 AM");
    expect(formatScheduleTimeLabel("09:30")).toBe("9:30 AM");
    expect(formatScheduleTimeLabel("12:00")).toBe("12:00 PM");
    expect(formatScheduleTimeLabel("17:00")).toBe("5:00 PM");
  });
