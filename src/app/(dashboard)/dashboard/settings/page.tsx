    ...
    <div>
      ...
      <div className="card p-6">
        ...
        {activeTab === 'integrations' && (
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Social & Review Links</h3>
              ...
              <div className="mb-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
                <label className="flex items-start gap-3 cursor-pointer">
                  <input
                    ...
                    onChange={(e) => handleInputChange('aiReceptionistSpanishEnabled', e.target.checked)}
      ...
      {cropModalOpen && imageToCrop && (
        <div data-mobile-overlay="true" className="fixed inset-0 bg-black/70 flex items-center justify-center z-[70] p-4">
