...
describe("services page cache sync contract", () => {
  ...
  it("includes owner-managed employee app access with privacy copy", () => {
    ...
    expect(source).toContain("create their own password");
    expect(source).toContain("step-by-step sign-in instructions");
    expect(source).toContain("Login is enabled");
    expect(source).toContain("Login is disabled");
    expect(source).toContain("Turn employee login on");
    expect(source).toContain("Turn employee login off");
    expect(source).not.toContain("Disable login");
    expect(source).toContain("Saving will turn off their employee login");
    expect(source).toContain("Make sure their email is correct before saving.");
    expect(source).toContain("active employee web");
    expect(source).not.toContain("staffPortalAccessMutation");
