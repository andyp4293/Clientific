          ...
          <div className="bg-white rounded-xl max-w-lg w-full p-6 shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleServiceSubmit} className="space-y-4">
              ...
              <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-lg">
                ...
                />
                <label htmlFor="serviceActive" className="text-sm text-gray-700">
              ...
              {saveServiceMutation.isError && (
                <div className="p-3 bg-red-50 border border-red-200 rounded-lg">
                  <p className="text-sm text-red-600">{saveServiceMutation.error?.message || 'Failed to save service'}</p>
                </div>
              )}
          ...
          <div className="bg-white rounded-xl max-w-lg w-full p-6 shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleStaffSubmit} className="space-y-4">
              ...
              {saveStaffMutation.isError && (
                <div className="p-3 bg-red-50 border border-red-200 rounded-lg">
                  <p className="text-sm text-red-600">{saveStaffMutation.error?.message || 'Failed to save staff member'}</p>
                </div>
              )}
