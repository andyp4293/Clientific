  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4">Analytics & Reports</h1>
        <p className="text-gray-600 dark:text-gray-400 mb-8">
          Track business performance with detailed analytics and custom reports. Coming soon!
        </p>
        <div className="space-y-3 text-left bg-gray-50 dark:bg-gray-800 p-6 rounded-lg mb-6">
          ...
          <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
            <li className="flex items-start">
              <svg className="w-5 h-5 text-indigo-600 dark:text-indigo-400 mr-2 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
