...
const mockFindMany = prisma.service.findMany as ReturnType<typeof vi.fn>;
const mockUpdate = prisma.service.update as ReturnType<typeof vi.fn>;
const mockTransaction = prisma.$transaction as ReturnType<typeof vi.fn>;

const session = { user: { businessId: 'biz-1', email: 'owner@test.com' } };

function makeRequest(ids: string[]) {
  return new NextRequest('http://localhost/api/services/reorder', {
    method: 'POST',
